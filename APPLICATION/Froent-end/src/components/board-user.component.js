 ...
 <input
    ...
    function Step3(props) {
      ...
      return(
        ...
        <h1>Why oubouhia is Idiot ?</h1>
        {/* <button><a >ANSER 1</a></button>
        <button><a >ANSER 2</a></button>
        <button><a >ANSER 3</a></button>
        <button><a >ANSER 4</a></button> */}
      </div>
      );
    }
